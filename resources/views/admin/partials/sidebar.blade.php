<aside class="sidenav navbar overflow-y-auto navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 inset-y-0">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::routeIs('data-angkatan.index') ? 'active' : '' }}" href="{{ route('data-angkatan.index') }}">
            ...
            <span class="nav-link-text ms-1">Data Angkatan</span>
          </a>
        </li>
        <li class="nav-item">
